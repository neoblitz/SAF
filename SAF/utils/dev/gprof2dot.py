...
class DotWriter:
    ...
    def graph(self, profile, theme):
        ...
        self.attr('graph', fontname=fontname, ranksep=0.25, nodesep=0.125, label=self.glabel, labelloc="t")
...
class Main:
    ...
    def main(self):
        ...
        parser.add_option(
            '--caption',
            type="string", dest="caption", default="",
            help="caption for the generated graph.")
    ...
    def write_graph(self,label):
        dot = DotWriter(self.output,label)
        profile = self.profile
