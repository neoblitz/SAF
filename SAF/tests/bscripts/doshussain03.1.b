...
# 
# $URL: http://thirdeye.deterlab.net/svn/trunk/SAF/knowbase/usermodels/doshussain03.b $  
...
sB = IPPKTPAIR.ip_pkt_sd(sipaddr!=$sA.sipaddr, dipaddr=$sA.dipaddr)[bcount>=1]

#-------------------------------------------------------------------------------
# For hypothesis 2, we define sC similar to sB but need to make sure that there
# are atleast 40000 events to begin with
#-------------------------------------------------------------------------------
...
#        that there is atleast 1 event matching sA followed by 59 events 
